...
/**
 ...
 @return 编辑动作
 */
- (NSArray<MNTableViewCellEditAction *> *_Nullable)tableViewCell:(MNTableViewCell *)cell editingActionsForRowAtIndexPath:(NSIndexPath *)indexPath;
/**
 编辑按钮点击处理
 @param cell 表格
 @param action 动作
 ...
 @return 二次处理视图
 */
- (UIView *_Nullable)tableViewCell:(MNTableViewCell *)cell commitEditingAction:(MNTableViewCellEditAction *)action forRowAtIndexPath:(NSIndexPath *)indexPath;
@end
...
/**
 交互代理
 */
@property (nonatomic, weak, nullable) id<MNTableViewCellDelegate> editDelegate;
/**
 是否编辑开启入口
 */
...
/**
 编辑视图
 */
@property (nonatomic, readonly, weak, nullable) UIView *editingView;
/**
 是否处于编辑状态
 */
...
/**
 滑动手势冲突
 */
@property (nonatomic, weak, nullable) UIGestureRecognizer *failToGestureRecognizer;
...
@interface UITableView (MNCellEditing)
...
@interface UIGestureRecognizer (MNCellEditing)

/**标记手势*/
@property (nonatomic, copy) NSString *cell_edit_label;
