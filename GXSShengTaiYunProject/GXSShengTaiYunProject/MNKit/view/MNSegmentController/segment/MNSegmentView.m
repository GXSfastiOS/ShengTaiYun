...
- (void)createView {
    ...
    UIView *separator = [[UIView alloc]initWithFrame:CGRectMake(0.f, 0.f, self.width_mn, (UIScreen.mainScreen.scale >= 3.f ? .5f : 1.f))];
...
{
    MNSegmentCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kMNSegmentItemIdentifier
