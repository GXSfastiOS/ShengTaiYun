...
- (void)createView {
    ...
    UILabel *timeLabel = [UILabel labelWithFrame:CGRectZero text:[NSString stringWithFormat:@"00:00/%@", [NSDate playTimeStringWithInterval:@(self.duration)]] alignment:NSTextAlignmentCenter textColor:MNVideoTailorWhiteColor font:[UIFont systemFontOfSize:12.f]];
