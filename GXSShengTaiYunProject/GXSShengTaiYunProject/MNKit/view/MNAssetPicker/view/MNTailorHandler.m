...
- (void)reloadSubviews {
    ...
    leftHandlerHighlightedLayer.strokeColor = self.pathColor.CGColor;//self.normalColor.CGColor;
    ...
    rightHandlerHighlightedLayer.strokeColor = self.pathColor.CGColor;//self.normalColor.CGColor;
