...
- (BOOL)isHEIFAsset {
    ...
    if (@available(iOS 9.0, *)) {
        ...
        [resources enumerateObjectsUsingBlock:^(PHAssetResource * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            if ([UTI containsString:@"heif"] || [UTI containsString:@"heic"]) {
                isHEIF = YES;
                *stop = YES;
            }
        }];
    ...
    isHEIF = ([UTI containsString:@"heif"] || [UTI containsString:@"heic"]);
#endif
    return isHEIF;
}
