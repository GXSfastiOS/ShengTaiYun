...
/**设置默认内容类型*/
UIKIT_EXTERN void MNLoadDialogSetContentStyle (MNLoadDialogContentStyle type);
UIKIT_EXTERN MNLoadDialogContentStyle MNLoadDialogGetContentStyle (void);

/**设置默认弹窗类型*/
UIKIT_EXTERN void MNLoadDialogSetDefaultStyle (MNLoadDialogStyle style);
UIKIT_EXTERN MNLoadDialogStyle MNLoadDialogGetDefaultStyle (void);

/**获取弹窗内容颜色*/
UIKIT_EXTERN UIColor *MNLoadDialogContentColor (void);
