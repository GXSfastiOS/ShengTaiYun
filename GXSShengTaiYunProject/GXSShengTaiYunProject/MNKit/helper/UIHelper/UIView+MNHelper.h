 ...
 */
- (void)xg_setCornerRect:(UIRectCorner)corners radius:(CGFloat)cornerRadius;
/**
 对view切部分圆角
 ...
 @param cornerRadius 圆角大小
 */
- (void)xg_setRect:(CGRect)bounds cornerRect:(UIRectCorner)corners radius:(CGFloat)cornerRadius;


/// 截取视图转Image
/// @param range 截图区域
- (UIImage *)xg_imageByViewInRect:(CGRect)range;
